...
// handler: extracts the dependencies of a apps/v1/StatefulSet item
const handler = (deployment, pods) => {
    ...
    const dependencies = Dependency.addDependencies(dependenciesList, path, index, cluster, ns, GVK.StatefulSet, name, nr);
